create table revenue (DepartmentId int, Revenue int, Year int);
...
values (1,10030,1998),(2,20000,1998),(3,40000,1998),
 ...
 select * from revenue order by DepartmentId, year;
 ...
 over (partition by DepartmentId
 order by Year
 rows between unbounded preceding and current row) as MinRevenueBeyond
 from revenue
 order by DepartmentId, Year


 -- https://stevestedman.com/2012/03/transact-sql-over-clause-rows-unbounded-preceding-or-following/